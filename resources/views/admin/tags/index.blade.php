                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a class="btn btn-success btn-sm" href="{{ route('admin.tags.create') }}">Add new</a>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="btn-group">
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('admin.tags.show', $item->id) }}">Show</a>
                                                <a class="btn btn-warning btn-sm"
                                                    href="{{ route('admin.tags.edit', $item->id) }}">Edit</a>
