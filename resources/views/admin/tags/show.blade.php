                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="{{ route('admin.tags.index') }}">List tag</a></li>
                                <li class="active">Show tag</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Add New Tag</strong>
                        </div>
                            ...
                            <div class="card-body card-block">
                                <form action="{{ route('admin.tags.store') }}" method="post"
                                    ...
                                    <div class="form-group row">
                                        <label for="name" class="col-sm-2 col-form-label">Name tag</label>
                                        <div class="col-sm-10">
                                            <input type="text" id="name" name="name"
                                           class="form-control" value="{{ ($tag->name ) }}" readonly>
