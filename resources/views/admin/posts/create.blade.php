                        ...
                        <div class="live-preview">
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="employeeName" name="title" placeholder="Nhập tên">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="employeeEmail" name="user_id" placeholder="Nhập tên tác giả" value="{{ $authorName }}" readonly>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3 d-flex justify-content-start">
                                    ...
                                    <div class="form-check form-switch form-switch-danger ms-3">
                                        <input class="form-check-input" type="checkbox" value="1" role="switch" id="is_trending" name="is_trending">
